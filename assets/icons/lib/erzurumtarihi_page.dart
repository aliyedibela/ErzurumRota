          ...
          return Stack(
            ...
            children: [
              ...
              Image.asset(
                ...
                fit: BoxFit.cover,
                errorBuilder: (c, o, s) =>
                    Container(color: Colors.grey.shade900), // Hata önleyici
              ),
              ...
              BackdropFilter(
                filter: ImageFilter.blur(
                  sigmaX: 6,
                  sigmaY: 6,
                ), // Blur'u hafif kıstım, resim az daha belli olsun
                child: Container(
                    ...
                    gradient: LinearGradient(
                      ...
                      colors: [
                        Colors.black.withOpacity(
                          0.3,
                        ), // Üst kısım daha aydınlık
                        Colors.black.withOpacity(
                          0.7,
                        ), // Alt kısım metin için koyu
                      ],
                    ),
                  ),
                ),
              ...
              // 📜 Metin katmanı (SafeArea ve Scroll eklendi)
              SafeArea(
                child: Padding(
                  ...
                  child: Column(
                    mainAxisAlignment:
                        MainAxisAlignment.end, // Aşağı yasla (Instagram style)
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Spacer(), // Üstü boş bırak, görsel gözüksün
                      // Başlık
                      Text(
                        item["baslik"]!,
                      ...
                      const SizedBox(height: 40), // Alt ok için boşluk
                    ],
                  ),
                ),
              ),

              // 🔽 Kaydırma göstergesi (Animasyonlu hissi verelim)
