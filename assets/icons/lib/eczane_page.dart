...
import 'package:url_launcher/url_launcher.dart'; // Telefon araması için
import 'eczane.dart';
      ...
      child: ClipRRect(
        ...
        child: BackdropFilter(
          ...
          child: Column(
            ...
            children: [
              // --- ÜST KISIM: İSİM VE İLÇE ---
              Padding(
                padding: const EdgeInsets.all(16),
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    // 🖼️ Kendi Eczane İkonun
                    Container(
              ...
              // --- ORTA KISIM: ADRES (Düzeltildi: Aşağıya akar) ---
              InkWell(
                onLongPress: () {
              ...
              // --- ALT KISIM: AKSİYON BUTONLARI (Kibarlaştırıldı) ---
              Padding(
