...
class _UserForgotPasswordScreenState extends State<UserForgotPasswordScreen> {
                  ...
                  child: Container(
                    ...
                    child: Column(children: [
                      ...
                      if (_codeSent) ...[
                        ...
                        _field(_codeCtrl, 'Doğrulama Kodu', Icons.vpn_key_outlined, type: TextInputType.number),
                        const SizedBox(height: 14),
                      ...
                      _loading
                          ...
                          : SizedBox(
                              ...
                              child: ElevatedButton.icon(
                                ...
                                icon: Icon(_codeSent ? Icons.check_rounded : Icons.send_rounded, color: const Color(0xFF1A237E)),
                                label: Text(_codeSent ? 'Şifreyi Güncelle' : 'Sıfırlama Kodu Gönder',
  ...
  Widget _field(TextEditingController ctrl, String hint, IconData icon,
      {bool obscure = false, TextInputType? type, Widget? suffix, bool enabled = true}) {
    return TextField(
      controller: ctrl, obscureText: obscure, keyboardType: type, enabled: enabled,
      ...
      decoration: InputDecoration(
        ...
        disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide(color: Colors.white.withOpacity(0.1))),
