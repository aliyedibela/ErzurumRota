      ...
      body: Container(
        ...
        child: _isLoading 
          ...
          : _notifications.isEmpty
            ? const Center(child: Text("Bildirim bulunamadı", style: TextStyle(color: Colors.white70)))
            : ListView.builder(
  ...
  Widget _buildNotificationCard(AppNotification note) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white.withOpacity(note.isRead ? 0.05 : 0.12),
        ...
        child: BackdropFilter(
          ...
          child: ListTile(
            ...
            leading: Container(
              ...
              decoration: BoxDecoration(
                color: note.isRead ? Colors.white10 : Colors.blueAccent.withOpacity(0.2),
